                        ...
                        return ValueListenableBuilder(
                            ...
                            builder: (context, value, child) {
                              if (value) {
                                ...
                                totalProyect.text = snapshot.data!.docs[0]
                                    .get('total_requerido')
                                    .toString();
                                imageProyect.text =
                                ...
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    textItem(
                                        'Link de la imagen', imageProyect, 2),
                                    SizedBox(
                                      height: 10,
                                    ),
                                    Container(
                                    ...
                                    ElevatedButton(
                                        ...
                                        child:
                                            const Text('Actualizar proyecto'))
                                  ],
                                );
                              } else {
                                return Responsive(
