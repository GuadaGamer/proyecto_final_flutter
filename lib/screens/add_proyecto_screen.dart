                ...
                ElevatedButton(
                    onPressed: () {
                      ...
                      _firebase.insProyecto({
                        ...
                        String idDocument = await _firebase.getLastProyecto();
                        await _empresasFirebase.updEmpresaCorreo(idDocument);
                        var snackBar = SnackBar(content: Text('Registro insertado'));
